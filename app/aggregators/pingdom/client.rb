		...
		class Client
			...
			def self.get(options = {})
				res = RestClient::Request.execute method: :get,
											...
											user: ENV['aggregator_pingdom_user'],
											password: ENV['aggregator_pingdom_passwd'],
											headers: { "app-key" => ENV["aggregator_pingdom_appkey"], "Accept" => "application/json", params: options[:params] }
